document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".k-navigation-list");
  const headerRef = document.querySelector(".k-header");
  const navigationRef = document.querySelector(".k-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".k-toggle-button img");
